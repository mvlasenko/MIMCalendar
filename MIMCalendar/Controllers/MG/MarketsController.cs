...
namespace MIMCalendar.Controllers.MG
{
    public class MarketsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name_eng,Name_ukr,Name_rus")] Market market)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name_eng,Name_ukr,Name_rus")] Market market)
        {
            if (ModelState.IsValid)
            {
